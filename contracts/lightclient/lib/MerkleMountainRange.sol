...
import {BitLength} from "./BitLength.sol";
...
library MerkleMountainRange {
    ...
    function verify(
        ...
        uint32 peakId = index.bitLength() - 1;
        require(merkleProof.length == peakId);
        bytes32 root = leaf;
